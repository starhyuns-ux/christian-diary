        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
                ...
                return (
                  <Link
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 ${
                      active
                        ? 'bg-brand-600 text-white shadow-lg scale-105 z-10'
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                className="md:hidden w-9 h-9 rounded-lg bg-slate-50 border border-slate-200 flex items-center justify-center shadow-sm active:scale-95 transition-all"
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all duration-200 ${
                      active ? 'bg-brand-600 text-white shadow-lg' : 'text-slate-600 hover:text-brand hover:bg-brand/5'
                    }`}
